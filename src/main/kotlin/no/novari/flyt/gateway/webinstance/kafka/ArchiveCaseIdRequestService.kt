...
import no.novari.flyt.gateway.webinstance.model.ArchiveCaseIdRequestParams
...
class ArchiveCaseIdRequestService(
    @param:Value("\${novari.kafka.application-id}") private val applicationId: String,
    @param:Value("\${novari.kafka.reply-topic.retention:1h}") private val replyRetention: Duration,
    @param:Value("\${novari.kafka.reply-topic.reply-timeout:10s}") private val replyTimeout: Duration,
